...
all: benchmark/distributed_join benchmark/all_to_all benchmark/tpch test/compare_against_shared test/prebuild test/buffer_communicator test/string_payload
...
clean:
	rm -f benchmark/distributed_join benchmark/all_to_all benchmark/tpch test/compare_against_shared test/prebuild src/communicator.o test/buffer_communicator test/string_payload
